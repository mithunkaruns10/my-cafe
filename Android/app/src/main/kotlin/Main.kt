...
internal val logger: SkipLogger = SkipLogger(subsystem = "my.cafe", category = "MyCafe")

private typealias AppRootView = MyCafeRootView
private typealias AppDelegate = MyCafeAppDelegate
